...
/**
 * clase que representa a el personaje de la CPU Greedy
 * Greedy: es especialista en pegarle a los premios que aparecen. Si no hay premio se comporta como un Extreme.
 * 
 ...
 * */
public class Greedy extends PersonajeCPU {
	private static final long serialVersionUID = -8795808354456393370L;
	private  final double direction = 0.1;

	/**
	 * constructor del PersonajeCPU Greedy del juego POOng
	 ...
	 * */
	public Greedy(double xPosition, double yPosition, double[] xMax){
	...
	public  void golpear( POOng game, Pelota pelota ){
		...
		if( game.getCurrentSorpresa() == null ){
			...
			pelota.golpeadoPorGreedy(sectorLastP, direction, game);
